 ...
 <div id="right_content">  <!--right content start-->  
		...
		if(isset($_GET['pro_id']))
	    {
		 ...
		 while($row_products=mysqli_fetch_array($run_product))
		 {
			 ...
			 <h3>$pro_title</h3>
			 <img src='admin_area/product_imges/$pro_image1' width='180' height='180'/> 
			 <img src='admin_area/product_imges/$pro_image2' width='250' height='250'/>
			 <img src='admin_area/product_imges/$pro_image3' width='250' height='250'/><br>
